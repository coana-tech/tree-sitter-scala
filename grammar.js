...
module.exports = grammar({
  ...
  rules: {
    ...
    import_declaration: $ =>
      prec.left(seq("import", sep1(",", $.namespace_expression))),

    export_declaration: $ =>
      prec.left(seq("export", sep1(",", $.namespace_expression))),
    ...
    _structural_instance: $ =>
      prec.left(
        ...
        seq(
          ...
          repeat(seq("with", field("body", $._constructor_application))),
    ...
    case_block: $ =>
      choice(
        prec(-1, seq($._open_brace, $._close_brace)),
        seq($._open_brace, repeat1($.case_clause), $._close_brace),
      ),
